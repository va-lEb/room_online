...
if( isset($_POST['titre']) && isset($_POST['description']) && isset($_POST['capacite']) && isset($_POST['categorie']) && isset($_POST['pays']) && isset($_POST['ville']) && isset($_POST['adresse']) && isset($_POST['cp']) ) {
    ...
    // Saisie obligatoire de tous les champs 
    ...
    if ( !empty($_FILES['photo']['name']) ) {
        ...
        if( in_array($extension, $tab_extension) ) {
            ...
            // Message d'eereur pour le format
            $msg .= '<div class="alert alert-danger mt-3">Attention, le format de l\'image est incorrect. Les formats autorisés sont jpg/jpeg/png/gif/webp.</div>';
            $erreur = true;
        }
...
// Récupération de la table salle
...
?>
    ...
    <main class="container-fluid px-4">
        ...
        <h4 class="px-3">Ajouter/Modifier</h4>
        <div class="row">
                ...
                <table class="table table-bordered">
                    ...
                    <?php 
                        while($ligne = $liste_salles->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            echo '<td><img src="' . URL. 'assets/images_salles/' . $ligne['photo'] . '" class="img-thumbnail" width="100"></td>';
                            ...
                            echo '<td><a href="?action=modifier&id_salle=' . $ligne['id_salle'] . '"  title="modifier" class="btn btn-warning text-white"><i class="fas fa-edit"></i></a></td>';
                            echo '<td><a href="?action=supprimer&id_salle=' . $ligne['id_salle'] . '" title="supprimer" class="btn btn-danger confirm_delete"><i class="far fa-trash-alt"></i></a></td>';
                            echo '</tr>';
                        }
                    ?>
                </table>
