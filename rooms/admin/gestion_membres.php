...
// Enregistrement et modification d'un membre
$id_membre = '';
$pseudo = '';
$mdp = '';
$civilite = '';
...
if( isset($_POST['pseudo']) && isset($_POST['mdp']) && ($_POST['civilite']) && isset($_POST['nom']) && isset($_POST['prenom']) && isset($_POST['email']) && isset($_POST['civilite']) && isset($_POST['statut']) ) {
    ...
    if($erreur == false) {
         ...
         // Si l'id_membre n'est pas vide -> le modifier
                ...
                <table class="table table-bordered">
                    ...
                    <?php 
                        while($ligne = $liste_membres->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            echo '<td data-title="Date enregistrement">' . $ligne['date_enregistrement'] . '</td>';
                            echo '<td><a href="?action=modifier&id_membre=' . $ligne['id_membre'] . '"  title="modifier" class="btn btn-warning text-white"><i class="fas fa-edit"></i></a></td>';
                            echo '<td><a href="?action=supprimer&id_membre=' . $ligne['id_membre'] . '" title="supprimer" class="btn btn-danger confirm_delete"><i class="far fa-trash-alt"></i></a></td>';
                            echo '</tr>'; 
                            echo '</tbody>';                          
